...
<h5>Harga: Rp. <?php $harga = $detail['harga']-($detail['harga'] * 0.05);  echo number_format($harga,0,",","."); ?></h5>
<p class="card-text">
...
<?php echo $detail['deskripsi'];?></p>
 ...
 <input type="hidden" name="harga" value="<?php $harga = $detail['harga']-($detail['harga'] * 0.05); echo $harga; ?>" />
