...
t>
 ...
 <li><a href="<?php echo base_url()?>member/page/tentang"><i class="glyphicon glyphicon-user"></i> Tentang</a></li>
 <li><a href="<?php echo base_url()?>member/page/cara_bayar"><i class="glyphicon glyphiconbriefcase"></i> Cara Bayar</a></li>
 <li><a href="<?php echo base_url()?>member/tampil_cart"><i class="glyphicon glyphiconshopping-cart"></i> Keranjang Belanja</a></li>
 <li><a href="<?php echo base_url()?>member/login/logout"><i class="glyphicon glyphiconshopping-cart"></i> Logout </a></li>
