...
base_url()?>shopping/tampil_cart"><i class="glyphicon glyphiconshopping-cart"></i> Keranjang Belanja</a></li>
 <li><a href="<?php echo
base_url()?>member"><i class="glyphicon glyphiconshopping-cart"></i> Login Member</a></li>
<li><a href="<?php echo
base_url()?>login/login"><i class="glyphicon glyphiconshopping-cart"></i> Admin </a></li>
